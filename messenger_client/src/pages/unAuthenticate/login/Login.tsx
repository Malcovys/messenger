...
function Login() {
    ...
    async function fetchLogin() {
        const loginData : LoginParams = { email: email, password: password }
    ...
    return (
        <div id="login" className="flex justify-center items-center flex-grow">
            <div id="form-container" className="flex justify-center shadow-xl min-w-96 py-8">
